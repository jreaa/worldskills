...
<div id="top" class="container search">
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
            ...
            <p class="lead my-5">Cambia la forma de ver el mundo con tu codigo. ?Es más divertido hacerse pirata que unirse a la marina? - Steve Job</p>
                    ...
                    <form action="ServletRegistro" method="POST">
                        ...
                        <div class="form-gruop">
                            ...
                            <select name="pais" class="form-control" id="country" required>
                                <option value="0" id="AF">Elegir opción</option>
