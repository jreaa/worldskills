...
public class ServletFollow extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String f = request.getParameter("follow");
        ...
        String msg2;
            ...
            try {
                ...
                msg = tcu.Follow(Integer.parseInt(id_tema), Integer.parseInt(id_usuario));
                if (Integer.parseInt(msg) != 0) {
                    msg2 = "Se ha comenzado a seguir satisfactoriamente";
