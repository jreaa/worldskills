...
public class ServletComentarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            comentario.setId_usuarios(Integer.parseInt(id_usuario));
            comentario.setId_tema(Integer.parseInt(id_tema));
            comentario.setContenido(contenido);
            ComentariosCRUD tcu = new ComentariosCRUD();
            msg = tcu.Create(comentario);
