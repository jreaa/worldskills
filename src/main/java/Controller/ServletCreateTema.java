 ...
 * @author Usuaria
 */
public class ServletCreateTema extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String descripcion = request.getParameter("tcontenido");
        ...
        try {
            ...
            tema.setId_usuarios(Integer.parseInt(id));
            tema.setTitle(tname);
            tema.setDescription(descripcion);
